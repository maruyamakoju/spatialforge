...
const FRAMES = [
  { name:'jrsam3_02s', ts:2,  video:'jrsam3', label:'jrsam3 02s', min:2.55, max:159.1, conf:0.875, ms:10.2,
    anoms:[
      {x:199, y:350, w:103, h:149, dist:7.3,  area:15347,  sev:'major',    cls:'rail_spalling',    clsConf:0.92, depth:7.8},
      {x:2,   y:534, w:632, h:106, dist:8.9,  area:66992,  sev:'critical', cls:'rail_crack',       clsConf:0.56, depth:11.2},
      {x:0,   y:179, w:609, h:446, dist:11.1, area:271614, sev:'minor',    cls:'rail_corrugation', clsConf:0.56, depth:4.5},
      {x:8,   y:156, w:632, h:155, dist:10.9, area:97960,  sev:'critical', cls:'rail_crack',       clsConf:0.48, depth:6.0},
      {x:157, y:434, w:20,  h:22,  dist:7.1,  area:440,    sev:'major',    cls:'rail_spalling',    clsConf:0.40, depth:7.9},
      {x:359, y:431, w:23,  h:25,  dist:9.3,  area:575,    sev:'major',    cls:'rail_spalling',    clsConf:0.29, depth:10.5},
      {x:229, y:161, w:96,  h:93,  dist:7.8,  area:8928,   sev:'major',    cls:'rail_spalling',    clsConf:0.26, depth:9.4},
      {x:223, y:160, w:118, h:112, dist:6.6,  area:13216,  sev:'major',    cls:'rail_spalling',    clsConf:0.25, depth:11.2},
    ] },
  { name:'jrsam3_04s', ts:4,  video:'jrsam3', label:'jrsam3 04s', min:2.71, max:180.7, conf:0.884, ms:8.3,
    anoms:[
      {x:22,  y:342, w:102, h:165, dist:10.6, area:16830,  sev:'major',    cls:'rail_spalling',    clsConf:0.85, depth:4.5},
      {x:23,  y:222, w:595, h:368, dist:4.2,  area:218960, sev:'minor',    cls:'rail_corrugation', clsConf:0.56, depth:6.9},
      {x:0,   y:531, w:630, h:109, dist:5.5,  area:68670,  sev:'critical', cls:'rail_crack',       clsConf:0.54, depth:6.0},
      {x:386, y:466, w:30,  h:41,  dist:6.3,  area:1230,   sev:'major',    cls:'rail_spalling',    clsConf:0.47, depth:7.8},
      {x:0,   y:182, w:639, h:143, dist:9.0,  area:91377,  sev:'critical', cls:'rail_crack',       clsConf:0.43, depth:7.4},
      {x:177, y:440, w:25,  h:23,  dist:7.2,  area:575,    sev:'major',    cls:'rail_spalling',    clsConf:0.33, depth:5.0},
    ] },
  { name:'jrsam3_07s', ts:7,  video:'jrsam3', label:'jrsam3 07s', min:1.51, max:15.1,  conf:0.886, ms:13.1,
    anoms:[
      {x:35,  y:0,   w:280, h:531, dist:6.2,  area:148680, sev:'major',    cls:'rail_spalling',    clsConf:0.84, depth:4.8},
      {x:91,  y:443, w:189, h:194, dist:4.8,  area:36666,  sev:'major',    cls:'rail_spalling',    clsConf:0.66, depth:8.2},
      {x:48,  y:53,  w:242, h:585, dist:4.9,  area:141570, sev:'major',    cls:'rail_spalling',    clsConf:0.36, depth:7.4},
    ] },
  { name:'jrsam3_11s', ts:11, video:'jrsam3', label:'jrsam3 11s', min:1.52, max:181.5, conf:0.862, ms:15.3,
    anoms:[
      {x:243, y:358, w:102, h:141, dist:9.1,  area:14382,  sev:'major',    cls:'rail_spalling',    clsConf:0.83, depth:8.3},
      {x:424, y:370, w:84,  h:108, dist:7.6,  area:9072,   sev:'major',    cls:'rail_spalling',    clsConf:0.66, depth:6.7},
      {x:20,  y:190, w:604, h:394, dist:7.9,  area:237976, sev:'minor',    cls:'rail_corrugation', clsConf:0.57, depth:8.4},
      {x:109, y:411, w:36,  h:38,  dist:6.7,  area:1368,   sev:'major',    cls:'rail_spalling',    clsConf:0.56, depth:4.4},
      {x:0,   y:506, w:634, h:133, dist:7.3,  area:84322,  sev:'critical', cls:'rail_crack',       clsConf:0.54, depth:5.5},
      {x:1,   y:162, w:634, h:109, dist:6.8,  area:69106,  sev:'critical', cls:'rail_crack',       clsConf:0.43, depth:6.8},
      {x:110, y:333, w:80,  h:76,  dist:5.2,  area:6080,   sev:'major',    cls:'rail_spalling',    clsConf:0.27, depth:11.0},
    ] },
  { name:'jrsam3_16s', ts:16, video:'jrsam3', label:'jrsam3 16s', min:2.74, max:162.2, conf:0.874, ms:7.0,
    anoms:[
      {x:189, y:455, w:75,  h:84,  dist:11.9, area:6300,   sev:'major',    cls:'rail_spalling',    clsConf:0.83, depth:8.7},
      {x:260, y:343, w:114, h:176, dist:5.4,  area:20064,  sev:'major',    cls:'rail_spalling',    clsConf:0.50, depth:11.9},
      {x:56,  y:129, w:573, h:439, dist:4.2,  area:251547, sev:'minor',    cls:'rail_corrugation', clsConf:0.45, depth:6.7},
      {x:9,   y:112, w:631, h:111, dist:8.9,  area:70041,  sev:'critical', cls:'rail_crack',       clsConf:0.39, depth:11.5},
      {x:219, y:141, w:420, h:425, dist:11.5, area:178500, sev:'minor',    cls:'rail_corrugation', clsConf:0.27, depth:8.9},
      {x:129, y:293, w:125, h:68,  dist:6.1,  area:8500,   sev:'major',    cls:'rail_spalling',    clsConf:0.26, depth:10.8},
    ] },
  { name:'jrsam3_21s', ts:21, video:'jrsam3', label:'jrsam3 21s', min:3.01, max:27.3,  conf:0.881, ms:10.2,
    anoms:[
      {x:336, y:216, w:248, h:319, dist:10.8, area:79112,  sev:'critical', cls:'rail_crack',       clsConf:0.81, depth:6.2},
    ] },
  { name:'jr23_02s',   ts:2,  video:'jr23',   label:'jr23 02s',   min:2.26, max:32.1,  conf:0.889, ms:10.4,
    anoms:[
      {x:303, y:0,   w:120, h:637, dist:8.2,  area:76440,  sev:'critical', cls:'rail_crack',       clsConf:0.79, depth:10.4},
      {x:48,  y:3,   w:139, h:632, dist:10.6, area:87848,  sev:'critical', cls:'rail_crack',       clsConf:0.32, depth:6.1},
      {x:47,  y:0,   w:186, h:363, dist:4.6,  area:67518,  sev:'critical', cls:'rail_crack',       clsConf:0.28, depth:6.0},
    ] },
  { name:'jr23_04s',   ts:4,  video:'jr23',   label:'jr23 04s',   min:1.88, max:17.3,  conf:0.858, ms:11.3,
    anoms:[
      {x:217, y:409, w:63,  h:71,  dist:10.2, area:4473,   sev:'major',    cls:'rail_spalling',    clsConf:0.79, depth:7.9},
      {x:0,   y:517, w:635, h:123, dist:12.0, area:78105,  sev:'critical', cls:'rail_crack',       clsConf:0.53, depth:11.3},
      {x:1,   y:200, w:639, h:130, dist:4.3,  area:83070,  sev:'critical', cls:'rail_crack',       clsConf:0.50, depth:4.9},
      {x:21,  y:236, w:612, h:352, dist:11.6, area:215424, sev:'minor',    cls:'rail_corrugation', clsConf:0.48, depth:8.6},
      {x:448, y:344, w:35,  h:31,  dist:8.9,  area:1085,   sev:'major',    cls:'rail_spalling',    clsConf:0.26, depth:9.3},
    ] },
  { name:'jr23_07s',   ts:7,  video:'jr23',   label:'jr23 07s',   min:3.36, max:17.9,  conf:0.862, ms:12.2,
    anoms:[] },
  { name:'jr23_11s',   ts:11, video:'jr23',   label:'jr23 11s',   min:2.57, max:156.9, conf:0.858, ms:11.1,
    anoms:[] },
  { name:'jr23_16s',   ts:16, video:'jr23',   label:'jr23 16s',   min:3.17, max:181.6, conf:0.893, ms:15.0,
    anoms:[] },
  { name:'jr23_21s',   ts:21, video:'jr23',   label:'jr23 21s',   min:2.64, max:22.9,  conf:0.876, ms:11.0,
    anoms:[] },
];
